 ...
 */
static struct dentry *sfs_lookup(struct inode *dir, struct dentry *dentry,,  unsigned int n)
{
...
static int sfs_create(struct inode *dir, struct dentry *dentry, umode_t mode, bool nd)
{
